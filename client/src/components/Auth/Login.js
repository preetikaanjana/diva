...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.identifier.trim() || !formData.password) {
      setError(t('Please enter your username or email and password'));
      return;
    }
      ...
      if (err.data?.requiresVerification) {
        setError(t(err.message) || t('Email not verified.'));
        setTimeout(() => {
        ...
        setError(t(err.message) || t('Login failed. Please try again.'));
      }
    }
  };
    ...
    <div className="auth-container">
      <div className="auth-card">
        <div className="auth-header">
          ...
          <p className="auth-subtitle">{t("Sign in with your username or email")}</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          <div className="form-group">
            ...
            <input
              ...
              placeholder={t("Your username or email address")}
              required
            />
          </div>
